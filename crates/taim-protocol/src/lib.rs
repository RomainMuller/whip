//! Shared protocol types for the taim application.
//!
//! This crate defines the core types used across all taim components,
...
//!
//! ```
//! use taim_protocol::{KanbanBoard, Task, LaneKind, TaskState};
//!
//! // Create a new board
