...
//!
//! This module defines the core task types used throughout the taim application,
...
///
/// ```
/// use taim_protocol::{Task, TaskState, LaneKind};
///
...
impl Task {
    ...
    ///
    /// ```
    /// use taim_protocol::{Task, LaneKind};
    ///
    /// let mut task = Task::new("Work item", "Do the thing");
